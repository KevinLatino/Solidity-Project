      ...
      <div className="mt-[3rem] flex flex-col items-center gap-6">
        <div className="flex text-center flex-col gap-6">
          ...
          <section className='flex flex-row gap-5'>
            ...
            {/* ESTE BOTON SERA VISIBLE SOLAMENTE CUANDO LA WALLET CONECTADA SEA LA DEL CREADOR DEL CONTRATO */}
            <button className="flex justify-center items-center gap-2 border-gradient p-3 text-xl transition"
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75">
            <div className="bg-gray-900 text-white p-8 rounded-lg shadow-lg w-[30rem]">
              ...
              <div className="mb-4">
                ...
                <button id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch" data-dropdown-placement="bottom" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Search by Wallet or Name <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/></svg></button>
